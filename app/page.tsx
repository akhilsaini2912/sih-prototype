  ...
  return <SiteShell>
    <section className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-16 pt-12 lg:grid-cols-[1.05fr_.95fr] lg:px-10 lg:pb-24 lg:pt-20">
      <div>
        ...
        <p className="mt-7 max-w-xl text-base leading-7 text-muted-foreground sm:text-lg">Yatra is an adaptive AI travel companion for discovering India&apos;s living culture, local businesses and slower journeys.</p>
